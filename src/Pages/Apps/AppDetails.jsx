...
const AppDetails = () => {
    ...
    const {image, title, companyName, description, downloads, ratingAvg, reviews, size} = singleApp;
    return (
            ...
            <div className='w-11/12 mx-auto py-12'>
                <div className='flex flex-col md:flex-row justify-between gap-10'>
                    ...
                    <div className='md:w-8/12'>
                        ...
                        <p className='text-[#627382]'>Developed by <span className='text-[#824BEB] font-semibold'>{companyName}</span></p>
                        <hr className='my-3 border-gray-300'/>
                        <div className='flex items-center gap-20'>
                            <div className='space-y-1'>
                                <img className='w-8' src={downloadLogo} alt="" />
                                <p className='text-[#314558]'>Downloads</p>
                                <p className='font-extrabold text-3xl'>{new Intl.NumberFormat("en-US", {
                                    notation:"compact"
                                }).format(downloads)}</p>
                            </div>
                            <div className='space-y-1'>
                        ...
                        <button className='btn mt-5 bg-[#00D390] text-white border-none hover:text-[#7841E9]'>Install Now ({size} GB)</button>
                    </div>
                </div>
                ...
                <div className='space-y-3'>
                    <h1 className='font-semibold'>Description: <span className='text-[#713BE7]'>{title}</span></h1>
